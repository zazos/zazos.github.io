...
var CONFIG = {
            ...
            projects: [
                {
                    ...
                    description: 'Research on Automatic Mood Classification (AMC) of music tracks using Machine Learning (ML) techniques. The project aims to classify music tracks into mood categories based on their audio features.',
                    imageUrl: 'https://www.researchgate.net/profile/Rui-Pedro-Paiva/publication/257308136/figure/fig1/AS:392743764414466@1470648818544/Thayers-model-of-mood-adapted-from-11.png',
    ...
    resume: {
        fileUrl: 'https://drive.google.com/file/d/1AI2nnwdFHfX2PWVMjFclWGt2vmK5pF38/view?usp=sharing'
    },
    skills: {
        languages: [
            'Python',
